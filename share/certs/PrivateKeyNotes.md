...
unlocked to sign the Duckduckcoin-Qt.app bundle.
...
allowing somebody to distribute a Duckduckcoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the duckduckcoin-qt.exe file inside the installer had not been tampered with.
