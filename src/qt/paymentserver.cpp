...
const QString BITCOIN_IPC_PREFIX("duckduckcoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click duckduckcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start duckduckcoin: click-to-pay handler");
    else
...
{
    // clicking on duckduckcoin: URLs creates FileOpen events on the Mac:
